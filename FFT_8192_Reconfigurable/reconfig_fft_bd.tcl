...
################################################################
# This is a generated script based on design: reconfig_fft
#
...
# source reconfig_fft_script.tcl
...
proc create_hier_cell_fft_block { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins data_dma/M_AXI_S2MM]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXI_LITE1] [get_bd_intf_pins data_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M_AXI_MM2S1] [get_bd_intf_pins data_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S1 [get_bd_intf_pins M_AXI_MM2S] [get_bd_intf_pins config_dma/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins config_dma/S_AXI_LITE]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S1 [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins fft_block/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net fft_block_M_AXI_MM2S1 [get_bd_intf_pins axi_smc/S01_AXI] [get_bd_intf_pins fft_block/M_AXI_MM2S1]
  connect_bd_intf_net -intf_net fft_block_M_AXI_S2MM [get_bd_intf_pins axi_smc/S02_AXI] [get_bd_intf_pins fft_block/M_AXI_S2MM]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fft_block/S_AXI_LITE1] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins fft_block/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fft_block/data_dma/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fft_block/config_dma/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg1
